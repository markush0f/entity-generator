...
const Aside: React.FC<Props> = ({ entities, onSelectEntity, setEntities }) => {
  ...
  return (
    <aside className="w-full bg-coebg text-white flex flex-col max-h-[calc(100vh-10rem)] min-h-[calc(100vh-10rem)] overflow-auto border border-gray-700 rounded aside-scrollbar">
      <h1 className="p-4 text-lg font-bold border-b border-gray-700 lg:text-lg sm:text-2xl">Entities created</h1>
